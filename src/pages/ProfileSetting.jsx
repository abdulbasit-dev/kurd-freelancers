            ...
            <div className="shadow-xl w-9/12 min-h-3/4 flex -my-14 z-10 bg-white flex-col xl:flex-row">
                <div className = "w-2/5 flex flex-col">
                    <div className="flex flex-col">
                        <div className="flex justify-center relative">
                            <div className="rounded-full w-48 h-48 flex justify-center items-center relative ml-6 mt-6 ">
                                <img src={data.image} alt="profileimage" className="w-full h-full rounded-full absolute" />
                    ...
                    <div className=" flex justify-center mt-3">
                        <div className="">
                            <h1 className="text-4xl ">{data1.firstname +" "+ data1.lastname}</h1>
                        </div>
                    </div>
                    <div className="flex justify-center text-gray-400 mt-4">
                        <h1>{data1.title.map((e, i) => {
                                ...
                                {data.projects.map((element, index) =>
                                    <div className="flex flex-col pl-1 mt-2" key = {index}>
                                        <div className="flex justify-between">
                                            <h1 className="flex text-gray-500">{index + 1}-{element.name} <a href="/profilesetting" className="text-cover ml-3">Demo</a><span className="text-gray-400 mx-2">|</span><a href="/profilesetting" className="text-cover">Github</a></h1>
                                            <img src={edit.editing && edit.id === index ? editIconOn : editIcon} alt="edit icon" className=" hover:cursor-pointer" onClick={(e)=>{
                ...
                <div className = "w-3/5  flex flex-col">
                    <div className="">
                        <ul className="flex justify-around text-2xl mt-10">
                            <li className={acountSettingState===0 ? " border-b-2 border-blue-400 pb-5 cursor-default":"cursor-default"} onClick={()=>{setAccountSettingState(0)}}>Account Settings</li>
                            <li className={acountSettingState===1 ? " border-b-2 border-blue-400 pb-5 cursor-default":"cursor-default"} onClick={()=>{setAccountSettingState(1)}}>Projects</li>
                            <li className={acountSettingState===2 ? " border-b-2 border-blue-400 pb-5 cursor-default":"cursor-default"} onClick={()=>{setAccountSettingState(2)}}>Social media</li>
                            <li className={acountSettingState===3 ? " border-b-2 border-blue-400 pb-5 cursor-default":"cursor-default"} onClick={()=>{setAccountSettingState(3)}}>privacy</li>
                        </ul>
                    </div>
                    {
                        acountSettingState === 0 &&
