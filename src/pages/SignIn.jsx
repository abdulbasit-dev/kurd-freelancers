...
const SignIn = () => {
    return (
        <div className="flex  justify-center items-center mt-28 overflow-x-hidden">
            <div className="relative min-h-100 flex rounded container w-full md:w-2/3 border-4  flex-col md:flex-row px-0 justify-center items-center shadow-xl">
                <div className="flex md:absolute left-0 bg-lightblue w-full rounded-l min-h-full md:w-5/12 flex-col pt-5 px-12 text-white">
                ...
                <div className="flex flex-col md:absolute items-center w-full md:w-7/12  rounded-r right-0 text-lightblue min-h-full shadow-xl ">
                    <h1 className="text-4xl mt-2">Log in</h1>
                    <div className="border w-96 max-w-full my-4"></div>
                    <div className="flex flex-col md:flex-row justify-around items-center w-96 flex-wrap ">
                    ...
                    <div className="flex w-96 mb-4 justify-between">
                        ...
                        <h1 className="mx-3 hidden md:block">Or</h1>
                        <div className="border w-44 my-4 hidden sm:block"></div>
                    </div>
                    <form action="" className="flex flex-col items-center w-96">
