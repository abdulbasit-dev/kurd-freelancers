...
function Setup() {
  return (
    <div className=" lg:flex lg:flex-row-reverse shadow-md md:w-2/3 mx-auto my-3 rounded-md border none">
        <div className="lg:w-2/5 bg-cover text-white py-4 px-6 md:px-12">
            <h1 className="text-3xl my-5">Complete Your Profile</h1>
            <p className="mb-3">Fill in your profile for employers to better understand your services when they visit your profile page.</p>
            <p>It is important to leave accurate information here to maximize your chances of getting jobs.</p>
            <p className="mb-3 mt-24 text-center">You can aslo press skip & complete your profile info later.</p>
            <div className="justify-center flex space-x-4 m-5">
              ...
              <button className="bg-white flex justify-center items-center w-24 text-cover p-1 rounded-md focus:outline-none">Next</button>
          </div>
        </div>
        <div className="lg:w-3/5 m-5">
            <div class="flex flex-col w-full lg:w-4/5 mb-5">
            ...
            <div class="flex flex-row  mb-5">
                ...
                <input type="tel" className="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="+964XXX XXX XXXX"/>
                </div>
            ...
            <div class="flex items-center space-x-4 mb-5">
                <div class="flex flex-col">
                    <label >Gender</label>
                    <select className="cursor-pointer px-3 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" name="gender">
                ...
                <div class="flex flex-col">
                    <label >Age</label>
                    <input type="number" className="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Number"/>
                </div>
            </div>
            <div class="flex flex-col w-full lg:w-full mb-5">
                <label>Skills</label>
                <Multiselect/>
            </div>
            <div class="flex items-center  space-x-4 mb-5">
                <div class="flex flex-col">
                    ...
                    <select className="cursor-pointer px-3 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" name="language">
