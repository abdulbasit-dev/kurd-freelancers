...
function About() {
	return (
		<div className="mt-20  md:mt-0 flex flex-col justify-center items-center ">
			<div className=" w-full hidden h-max rounded-full border-2 bg-transparent border-gray-500 mx-auto lg:-mt-100 xl:-mt-97 md:flex md:-mt-120   justify-center items-end z-0">
			...
			<div className="flex flex-col tablet:flex-row mx-10  sm:w-3/4 mt-10 justify-between w-full px-5">
				{
					data.goals.map((goal, i) => <GoalCard goal={goal} key={i} />)
				}
			</div>
